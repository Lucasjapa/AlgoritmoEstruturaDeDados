...
int main() {
    float* vetor;                   // Ponteiro para receber os dados do usuário.
    ...
    // Aloca na HEAP um espaço de 10 float (40 bytes) e verifica se o espaço foi alocado corretamente.
    vetor = malloc(sizeof(float) * TAMANHO_VETOR);
    if (vetor == NULL) {
